...
public class models {
	...
	public models(int sl_no, String invoice_currency, String cust_payment_terms) {
		super();
		this.sl_no = sl_no;
	...
	public models(int sl_no, String business_code, int cust_number,String name_customer, Date clear_date, int buisness_year, String doc_id,
	...
	public models(String business_code, int cust_number, Date clear_date, int buisness_year, String doc_id,
			...
			Date baseline_create_date, String cust_payment_terms, int invoice_id) {
		super();
		this.business_code = business_code;
		this.cust_number = cust_number;
		this.clear_date = clear_date;
	...
	public void setBusiness_year(int buisness_year) {
		this.buisness_year = buisness_year;
	}
