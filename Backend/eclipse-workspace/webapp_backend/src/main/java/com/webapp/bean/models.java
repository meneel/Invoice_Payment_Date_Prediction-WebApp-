...
public class models {
	...
	public models(int sl_no, String business_code, int cust_number, Date clear_date, int business_year, String doc_id,
	...
	public models(String business_code, int cust_number, Date clear_date, int business_year, String doc_id,
